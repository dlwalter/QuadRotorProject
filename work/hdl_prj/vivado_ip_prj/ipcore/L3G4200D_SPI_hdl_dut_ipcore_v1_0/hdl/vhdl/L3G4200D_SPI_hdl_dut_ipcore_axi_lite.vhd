-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\L3G4200D_SPI\L3G4200D_SPI_hdl_dut_ipcore_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: L3G4200D_SPI_hdl_dut_ipcore_axi_lite
-- Source Path: L3G4200D_SPI_hdl_dut_ipcore/L3G4200D_SPI_hdl_dut_ipcore_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY L3G4200D_SPI_hdl_dut_ipcore_axi_lite IS
...
END L3G4200D_SPI_hdl_dut_ipcore_axi_lite;


ARCHITECTURE rtl OF L3G4200D_SPI_hdl_dut_ipcore_axi_lite IS

  -- Component Declarations
  COMPONENT L3G4200D_SPI_hdl_dut_ipcore_addr_decoder
  ...
  COMPONENT L3G4200D_SPI_hdl_dut_ipcore_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : L3G4200D_SPI_hdl_dut_ipcore_addr_decoder
    USE ENTITY work.L3G4200D_SPI_hdl_dut_ipcore_addr_decoder(rtl);

  FOR ALL : L3G4200D_SPI_hdl_dut_ipcore_axi_lite_module
    USE ENTITY work.L3G4200D_SPI_hdl_dut_ipcore_axi_lite_module(rtl);
...
BEGIN
  u_L3G4200D_SPI_hdl_dut_ipcore_addr_decoder_inst : L3G4200D_SPI_hdl_dut_ipcore_addr_decoder
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
              ...
              read_x_gyro_low => read_x_gyro_low,  -- sfix8
              read_x_gyro_out => read_x_gyro_out,  -- sfix8
              read_y_gyro_low => read_y_gyro_low,  -- sfix8
              read_y_gyro_out => read_y_gyro_out,  -- sfix8
              read_z_gyro_low => read_z_gyro_low,  -- sfix8
              read_z_gyro_out => read_z_gyro_out,  -- sfix8
              read_who_am_i => read_who_am_i,  -- sfix8
              data_read => top_data_read,  -- ufix32
              write_axi_enable => write_axi_enable,  -- ufix1
              write_enable => write_enable  -- ufix1
              );

  u_L3G4200D_SPI_hdl_dut_ipcore_axi_lite_module_inst : L3G4200D_SPI_hdl_dut_ipcore_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1

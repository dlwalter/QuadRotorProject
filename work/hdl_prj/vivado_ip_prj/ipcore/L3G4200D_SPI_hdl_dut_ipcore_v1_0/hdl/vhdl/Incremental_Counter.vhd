-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\L3G4200D_SPI\Incremental_Counter.vhd
...
-- Source Path: L3G4200D_SPI/hdl_dut/Incremental Counter
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Incremental_Counter IS

  -- Component Declarations
  COMPONENT Detect_Increase1_block
    PORT( clk                             :   IN    std_logic;
          reset                           :   IN    std_logic;
          enb                             :   IN    std_logic;
          U                               :   IN    std_logic;
  ...
  FOR ALL : Detect_Increase1_block
    USE ENTITY work.Detect_Increase1_block(rtl);
...
BEGIN
  u_Detect_Increase1 : Detect_Increase1_block
    PORT MAP( clk => clk,
              reset => reset,
              enb => enb,
              U => Inc,

-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\BasicQuadrotorControl\PWM_Motor4.vhd
...
-- 
-- Module: PWM_Motor4
-- Source Path: BasicQuadrotorControl/hdl_dut/PWM_Motor4
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF PWM_Motor4 IS

  -- Component Declarations
  COMPONENT Calculate_f_coeff_block2
  ...
  FOR ALL : Calculate_f_coeff_block2
    USE ENTITY work.Calculate_f_coeff_block2(rtl);
...
BEGIN
  u_Calculate_f_coeff : Calculate_f_coeff_block2

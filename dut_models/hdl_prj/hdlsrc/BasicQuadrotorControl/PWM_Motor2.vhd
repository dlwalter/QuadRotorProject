-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\BasicQuadrotorControl\PWM_Motor2.vhd
...
-- 
-- Module: PWM_Motor2
-- Source Path: BasicQuadrotorControl/hdl_dut/PWM_Motor2
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF PWM_Motor2 IS

  -- Component Declarations
  COMPONENT Calculate_f_coeff_block
  ...
  FOR ALL : Calculate_f_coeff_block
    USE ENTITY work.Calculate_f_coeff_block(rtl);
...
BEGIN
  u_Calculate_f_coeff : Calculate_f_coeff_block

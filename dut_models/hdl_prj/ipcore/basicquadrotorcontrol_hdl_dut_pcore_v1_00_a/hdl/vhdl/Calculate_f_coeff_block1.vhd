-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\BasicQuadrotorControl\Calculate_f_coeff_block1.vhd
...
-- Source Path: BasicQuadrotorControl/hdl_dut/PWM_Motor3/Calculate f_coeff
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY Calculate_f_coeff_block1 IS
  PORT( pwm_freq                          :   IN    std_logic_vector(31 DOWNTO 0);  -- uint32
        f_coeff                           :   OUT   std_logic_vector(31 DOWNTO 0)  -- uint32
        );
END Calculate_f_coeff_block1;


ARCHITECTURE rtl OF Calculate_f_coeff_block1 IS

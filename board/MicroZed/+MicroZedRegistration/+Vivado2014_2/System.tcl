...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.ENABLE_ADVANCED_OPTIONS {0} CONFIG.ENABLE_PROTOCOL_CHECKERS {0} CONFIG.NUM_MI {1} CONFIG.STRATEGY {0}  ] $axi_interconnect_0

  # Create instance: clk_wiz_0, and set properties
  set clk_wiz_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:5.1 clk_wiz_0 ]
  set_property -dict [ list CONFIG.RESET_TYPE {ACTIVE_LOW}  ] $clk_wiz_0
  ...
  set_property -dict [ list CONFIG.PCW_IMPORT_BOARD_PRESET {MicroZed_7z020_RevB_v4.xml}  ] $processing_system7_0
